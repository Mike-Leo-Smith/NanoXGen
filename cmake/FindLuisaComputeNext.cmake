...
foreach(_component IN LISTS _luisa_next_library_names)
    ...
    find_library(LuisaComputeNext_${_component_upper}_LIBRARY
        ...
        PATHS
            "${LUISA_COMPUTE_BUILD_DIR}/bin"
            "${LUISA_COMPUTE_BUILD_DIR}/lib"
        NO_DEFAULT_PATH)
...
if(LuisaComputeNext_FOUND AND NOT TARGET LuisaComputeNext::DSL)
    if(WIN32)
        set(_luisa_next_platform_definition "LUISA_PLATFORM_WINDOWS=1")
    elseif(UNIX)
        set(_luisa_next_platform_definition "LUISA_PLATFORM_UNIX=1")
    else()
        message(FATAL_ERROR
            "The external LuisaCompute adapter does not support this platform")
    endif()
